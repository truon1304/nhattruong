...
<link rel="stylesheet" id="dashicons-css" href="https:///wp-includes/css/dashicons.min.css?ver=5.7.2" media="all">
<link rel="stylesheet" id="buttons-css" href="https:///wp-includes/css/buttons.min.css?ver=5.7.2" media="all">
<link rel="stylesheet" id="forms-css" href="https:///wp-admin/css/forms.min.css?ver=5.7.2" media="all">
<link rel="stylesheet" id="l10n-css" href="https:///wp-admin/css/l10n.min.css?ver=5.7.2" media="all">
<link rel="stylesheet" id="login-css" href="https:///wp-admin/css/login.min.css?ver=5.7.2" media="all">
		...
		<form name="loginform" id="loginform" action="https:///wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Đăng nhập">
					...
					<p id="nav">
								<a href="https:///wp-login.php?action=lostpassword">Bạn quên mật khẩu?</a>
			</p>
					<script type="text/javascript">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="https:///">&larr; Quay lại Trường-1304</a>		</p>
			</div>
	<script src="https:///wp-includes/js/jquery/jquery.min.js?ver=3.5.1" id="jquery-core-js"></script>
...
<script src="https:///wp-includes/js/dist/hooks.min.js?ver=50e23bed88bcb9e6e14023e9961698c1" id="wp-hooks-js"></script>
<script src="https:///wp-includes/js/dist/i18n.min.js?ver=db9a9a37da262883343e941c3731bc67" id="wp-i18n-js"></script>
...
<script src="https:///wp-admin/js/password-strength-meter.min.js?ver=5.7.2" id="password-strength-meter-js"></script>
...
<script src="https:///wp-includes/js/wp-util.min.js?ver=5.7.2" id="wp-util-js"></script>
...
<script src="https:///wp-admin/js/user-profile.min.js?ver=5.7.2" id="user-profile-js"></script>
	<div class="clear"></div>
	</body>
	</html>